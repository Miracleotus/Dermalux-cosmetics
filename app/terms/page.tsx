    ...
    <main className="bg-brand-dark text-white min-h-screen pt-32 pb-24 px-6 font-body">
      ...
      >
        ...
        <section className="mb-8">
          <h2 className="font-display text-2xl font-bold mb-4 text-brand-pink">1. Overview</h2>
        ...
        <section className="mb-8">
          <h2 className="font-display text-2xl font-bold mb-4 text-brand-pink">2. Products and Services</h2>
          <p className="text-brand-gray text-lg leading-relaxed">
        ...
        <section className="mb-8">
          <h2 className="font-display text-2xl font-bold mb-4 text-brand-pink">3. Changes to Terms</h2>
          <p className="text-brand-gray text-lg leading-relaxed">
